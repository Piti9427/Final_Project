          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form action="authorize_insert.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                      <div class="col-md-8">
                         <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="module">Define Branch</label>
                            <select class="form-control" name="branch_no">
                              <option value="">-- เลือก --</option>
                              <option value="การเงินและเศรษฐศาสตร">การเงินและเศรษฐศาสตร</option>
                              <option value="การจัดการ">การจัดการ	</option>
                              <option value="การบริหารธุรกิจระหว่างประเทศและโลจิสติกส์">การบริหารธุรกิจระหว่างประเทศและโลจิสติกส์	</option>
                ...
                <button type="button" class="btn btn-primary" onclick="confirmSubmission()">บันทึกข้อมูล</button>
                </div>
             </form>
            </div>
         </div>
